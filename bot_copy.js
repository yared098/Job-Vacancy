...
const contactInfo = `
Phone Number: 0988107722
Telegram Username: @yared_122

Description: Hi, I am Yared. Feel free to reach out to me!
`;
      ...
      bot.once('contact', async (msg) => {
        ...
        if (job.applytype === 'normal') {
          try {
            ...
            await bot.sendMessage(job.channel_id,`New job application:\nJob ID: ${job.id}\nTitle: ${job.title}\nPhone Number: ${phoneNumber}\nApplicant Username: ${username}`)
